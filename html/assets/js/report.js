    ...
    columns: [
      {
        render: (data, type, row) => {
          ...
          <text transform="translate(19.7129 7.40234)" fill="#1F1C24" stroke="white" stroke-width="0.5" xml:space="preserve" style="white-space: pre" font-family="Open Sans" font-size="14" font-weight="bold" letter-spacing="0.01em"><tspan x="-1.76913" y="14.4312">${row.rank}</tspan></text>
